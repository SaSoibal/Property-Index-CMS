...
import { NoticeComponent } from 'src/app/pages/notice/notice.component';
...
import { LoanBenefitComponent } from 'src/app/pages/loan-benefit/loan-benefit.component';
import { LoanBankComponent } from 'src/app/pages/loan-bank/loan-bank.component';
import { LoanApplyComponent } from 'src/app/pages/loan-apply/loan-apply.component';
import { PropertyStickerComponent } from 'src/app/pages/property-sticker/property-sticker.component';
import { PropertyAdsComponent } from 'src/app/pages/property-ads/property-ads.component';
import { DemoProjectComponent } from 'src/app/pages/demo-project/demo-project.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'contact-forms', component: ContactFormsComponent },
    { path: 'add-property-forms', component: AddPropertyFormsComponent },
    { path: 'request-property-forms', component: RequestPropertyFormsComponent },
    { path: 'loan/benefits', component: LoanBenefitComponent },
    { path: 'notifications', component: NotificationsComponent },
    { path: 'about-us', component: AboutUsComponent },
    { path: 'about-us/why-us', component: AboutUsWhyUsComponent },
    { path: 'about-us/gallery', component: AboutUsGalleryComponent },
    ...
    { path: 'notice', component: NoticeComponent },
    { path: 'loan/benefits', component: LoanBenefitComponent },
    { path: 'loan/banks', component: LoanBankComponent },
    { path: 'loan/apply', component: LoanApplyComponent },
    { path: 'property-management/sticker', component: PropertyStickerComponent },
    { path: 'property-ads', component: PropertyAdsComponent },
    { path: 'projects', component: DemoProjectComponent },
