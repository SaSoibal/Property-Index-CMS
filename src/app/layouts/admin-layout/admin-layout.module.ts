...
import { CreateUpdateNotice, NoticeComponent, NoticeDetails } from 'src/app/pages/notice/notice.component';
import { CreateContactForms, DeleteContactForms, ReadContactForms } from '../../pages/contact-forms/contact-forms.component';
import {
    DeleteAddPropertyForms,
    ReadAddPropertyForms
} from '../../pages/add-property-forms/add-property-forms.component';
import { DebounceChangeDirective } from 'src/app/directive/debounce-change.directive';
import { CreateLoanBenefit, DeleteLoanBenefit, LoanBenefitComponent, ViewLoanBenefit } from 'src/app/pages/loan-benefit/loan-benefit.component';
import { CreateLoanBank, DeleteLoanBank, LoanBankComponent, ViewLoanBank } from 'src/app/pages/loan-bank/loan-bank.component';
import { LoanApplyComponent } from 'src/app/pages/loan-apply/loan-apply.component';
import { CreatePropertyStickerDialog, DeletePropertyStickerDialog, PropertyStickerComponent } from 'src/app/pages/property-sticker/property-sticker.component';
import { CreatePropertyAds, DeletePropertyAds, PropertyAdsComponent, ViewPropertyAds } from 'src/app/pages/property-ads/property-ads.component';
import { CreateDemoProject, DeleteDemoProject, DemoProjectComponent, ReadDemoProject } from '../../pages/demo-project/demo-project.component';
import { CreateTeamMember, DeleteTeamMember, OurTeamComponent, ViewTeamMember } from '../../pages/our-team/our-team.component';
import {DeleteRequestPropertyForms, ReadRequestPropertyForms} from '../../pages/request-property-forms/request-property-forms.component';
...
@NgModule({
    ...
    declarations: [
        ...
        CreateContactForms, ReadContactForms, DeleteContactForms,
        ReadAddPropertyForms, DeleteAddPropertyForms, CreateCv, ReadCv, DeleteCv,
        ReadRequestPropertyForms, DeleteRequestPropertyForms,
        ...
        NoticeComponent, CreateUpdateNotice, NoticeDetails,
        DebounceChangeDirective,
        LoanBenefitComponent, CreateLoanBenefit, ViewLoanBenefit, DeleteLoanBenefit,
        NoticeComponent, CreateUpdateNotice, NoticeDetails,
        DebounceChangeDirective,
        LoanBenefitComponent, CreateLoanBenefit, ViewLoanBenefit, DeleteLoanBenefit,
        LoanBankComponent, CreateLoanBank, ViewLoanBank, DeleteLoanBank,
        LoanApplyComponent,
        PropertyStickerComponent, CreatePropertyStickerDialog, DeletePropertyStickerDialog,
        PropertyAdsComponent, CreatePropertyAds, ViewPropertyAds, DeletePropertyAds,
        DemoProjectComponent, CreateDemoProject, ReadDemoProject, DeleteDemoProject,
        OurTeamComponent, CreateTeamMember, ViewTeamMember, DeleteTeamMember
