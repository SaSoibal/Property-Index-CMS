...
import { AssignUserRoleComponent, AssignUserRoles, DeleteAssignUser } from '../../pages/administrator/assign-user-role/assign-user-role.component';
...
import { QcPropertyPendingListComponent, QcPendingModel, QcPendingDeleteModel } from '../../pages/data-collector/qc-property-lists/qc-property-pending-lists/qc-property-pending-list.component';
import {
...
import {ApproveListingComponent, QcApproveModel, ApproveAllocateModel} from '../../pages/data-collector/approve-listing/approve-listing.component';
// Property Manage
...
import {FSQcSalePendingListComponent, QcSalePendingModel, QcSalePendingDeleteModel} from '../../pages/property-manage/for-sale-qc-property-list/qc-sale-property-pending-lists/qc-sale-property-pending-list.component';
import {FSQcSaleRejectedListComponent, QcSaleRejectedModel, QcSaleRejectedDeleteModel} from '../../pages/property-manage/for-sale-qc-property-list/qc-sale-property-rejected-lists/qc-sale-property-rejected-list.component';
import {FSQcSaleDeletedListComponent, QcSaleDeleteddModel} from '../../pages/property-manage/for-sale-qc-property-list/qc-sale-property-deleted-lists/qc-sale-property-deleted-list.component';
...
import {FSQcRentPendingListComponent, QcRentPendingModel, QcRentPendingDeleteModel} from '../../pages/property-manage/for-rent-qc-property-list/qc-rent-property-pending-lists/qc-rent-property-pending-list.component';
import {FSQcRentRejectedListComponent, QcRentRejectedModel, QcRentRejectedDeleteModel} from '../../pages/property-manage/for-rent-qc-property-list/qc-rent-property-rejected-lists/qc-rent-property-rejected-list.component';
import {FSQcRentDeletedListComponent, QcRentDetailsModel} from '../../pages/property-manage/for-rent-qc-property-list/qc-rent-property-deleted-lists/qc-rent-property-deleted-list.component';
...
import {FLSQcLandSalePendingListComponent, QcLandSalePendingDeleteModel, QcLandSalePendingModel} from '../../pages/property-manage/for-land-sale-qc-property-list/qc-land-sale-property-pending-lists/qc-land-sale-property-pending-list.component';
import {FLSQcLandSaleRejectedListComponent, QcLandSaleRejectedDeleteModel, QcLandSaleRejectedModel} from '../../pages/property-manage/for-land-sale-qc-property-list/qc-land-sale-property-rejected-lists/qc-land-sale-property-rejected-list.component';
import {FLSQcLandSaleDeletedListComponent, QcLandSaleDetailsModel} from '../../pages/property-manage/for-land-sale-qc-property-list/qc-land-sale-property-deleted-lists/qc-land-sale-property-deleted-list.component';

import {FSApproveListingComponent, ApprovedDetailsModel, SaleListingModel} from '../../pages/property-manage/approve-listing/for-sales/for-sales-approve-listing.component';
import {FRApproveListingComponent, ApprovedRentDetailsModel, RentListingModel} from '../../pages/property-manage/approve-listing/for-rent/for-rent-approve-listing.component';
import {FLSApproveListingComponent, ApprovedLandSaleDetailsModel, LandSaleListingModel} from '../../pages/property-manage/approve-listing/for-land-sales/for-land-sale-approve-listing.component';
import {ProductComponent, ProductDetailsModel, ProductStepModel} from '../../pages/property-manage/product/product.component';
import {RentProductComponent, RentProductDetailsModel, RentProductStepModel} from '../../pages/property-manage/product/rent-product/rent-product.component';
import {LandSaleProductComponent, LandSaleProductDetailsModel, LandSaleProductStepModel} from '../../pages/property-manage/product/land-sale-product/land-sale-product.component';
import { FSReassignPropertyComponent, ReassignDetailsModel, SaleReassignModel } from '../../pages/property-manage/reassign-property/for-sales/for-sales-reassign-property.component';
import { FRReassignPropertyComponent,RentReassignDetailsModel,RentReassignModel} from '../../pages/property-manage/reassign-property/for-rent/for-rent-reassign-property.component';
import { FLSReassignPropertyComponent,LandSaleReassignDetailsModel,LandSaleReassignModel} from '../../pages/property-manage/reassign-property/for-land-sales/for-land-sale-reassign-property.component';
...
import {WebsiteSalePropertyListComponent, WBSsaleDetailsModel} from '../../pages/website-listing/website-sale-list/website-sale-property-list.component';
import {WebsiteRentPropertyListComponent, WBSrentDetailsModel} from '../../pages/website-listing/website-rent-list/website-rent-property-list.component';
import {WebsiteLandSaleListComponent, WebsiteLandSaleModel} from '../../pages/website-listing/website-land-sale-list/website-land-sale-property-list.component';
// Lead Manage
...
import { SearchLeadComponent, SearchStepTodolist, SearchPropertyModel, SearchRescheduleReassign} from '../../pages/leads/search-lead/search-lead.component';
...
import { ClassificationComponent, CreateClassification, DeleteClassification } from '../../pages/system-settings/classification/classification.component';
import { TaskSubTypeComponent, CreateTaskSubType, DeleteTaskSubType } from '../../pages/system-settings/task-sub-type/task-sub-type.component';
...
import { ClientRatingComponent, CreateClientRating, DeleteClientRating } from '../../pages/system-settings/client-rating/client-rating.component';
...
import { SelectSourceComponent, CreateSelectSource, DeleteSelectSource } from '../../pages/system-settings/select-source/select-source.component';
...
import { PreferredTenantsComponent, AddTenants, DeleteTenants } from '../../pages/system-settings/preferred-tenants/preferred-tenants.component';
import { ProjectComponent, CreateProject, DeleteProject } from '../../pages/system-settings/project/project.component';
import { ConstructionStatusComponent,CreateConstructionStatus,DeleteConstructionStatus } from '../../pages/system-settings/construction-status/construction-status.component';
...
// Add Property
import { BannerSectionComponent, CreateBanner, ReadBanner, DeleteBanner } from '../../pages/add-property/banner-section/banner-section.component';
import { HowItWorkComponent, CreateHIW, ReadHIW, DeleteHIW } from '../../pages/add-property/how-it-work/how-it-work.component';
import { CustomerExperiencesComponent, CreateCustomerExp, ReadCustomerExp, DeleteCustomerExp } from '../../pages/add-property/customer-experiences/customer-experiences.component';
import { FaqComponent, CreateFaq, ReadFaq, DeleteFaq } from '../../pages/add-property/faq/faq.component';
// Blog
import { BlogBannerComponent, CreateBlogBanner, ReadBlogBanner, DeleteBlogBanner } from '../../pages/blog/banner-manage/banner-manage.component';
import { BlogCategoryComponent, CreateBlogCategory, ReadBlogCategory, DeleteBlogCategory } from '../../pages/blog/blog-category/category-manage.component';
...
import { AreaOptionComponent, CreateAreaOption, ReadAreaOption, DeleteAreaOption } from '../../pages/area-guides/area-option/area-option.component';
...
import { GuideDetailsComponent, CreateGuideDetails, ReadGuideDetails, DeleteGuideDetails } from '../../pages/buy-and-sell/guide-details/guide-details.component';
// todo list
import { TransferListComponent, TransferApproveModel, TransferLeadsDetails, TransferUserDetails} from '../../pages/leads/transfer-list/transfer-list.component';
// Customer Care
...
import { DailyActivityReportComponent, StepActivityWiseLeadModel } from '../../pages/lead-management/daily-activity-report/daily-activity-report.component';

// Settings > project settings
import { ProjectSettingsComponent } from '../../pages/settings/project-settings/project-settings.component';
import { ProjectSubTypeComponent, CreateProjectSubType, DeleteProjectSubType } from '../../pages/settings/project-settings/project-sub-type/project-sub-type.component';
...
import { InteriorListComponent, CreateInterior, DeleteInterior, ReadInterior } from '../../pages/interior/interior-list/interior-list.component';
import { InteriorDetailsComponent } from '../../pages/interior/interior-details/interior-details.component';
import { InteriorInformationComponent, CreateInteriorInfo, DeleteInteriorInfo, ReadInteriorInfo } from '../../pages/interior/interior-details/intorior-information/interior-information.component';
import { WhatWeProvideComponent, CreateWhatWeProvide, DeleteWhatWeProvide, ReadWhatWeProvide } from '../../pages/interior/interior-details/what-we-provide/what-we-provide.component';
import { InteriorGalleryComponent, CreateGallery, DeleteGallery } from '../../pages/interior/interior-details/gallery/interior-gallery.component';
import { InteriorFaqComponent, CreateInteriorFaq, DeleteInteriorFaq, ReadInteriorFaq } from '../../pages/interior/interior-details/interior-faq/interior-faq.component';
