...
@Component({
  ...
  templateUrl: './website-sale-property-list.component.html',
  styleUrls: ['./website-sale-property-list.component.scss']
})
export class WebsiteSalePropertyListComponent implements OnInit {
  ...
  detailsModel(property, details) {
    const dialogRef = this.dialog.open( WBSsaleDetailsModel, {
      width: '800px',
      data: {
...
@Component({
  ...
  templateUrl: './sale-details-modal.html',
  styleUrls: ['./website-sale-property-list.component.scss']
})
export class WBSsaleDetailsModel {
  submitButton = false;
  tokenId = this.common.mycookie.bearertoken;
  rootUrl =  this.common.rootUrl + 'public/uploads/';
  constructor(public dialogRef: MatDialogRef<WBSsaleDetailsModel>,
