...
@Component({
  selector: 'app-customer-care-lead',
  templateUrl: './customer-care-lead.component.html',
  styleUrls: ['./customer-care-lead.component.scss']
})
export class CustomerCareLeadComponent implements OnInit {
  ...
  permission(type) {
    return this.common.permission('customer-care/lead', type);
  }
  ...
  setDataList(data) {
    ...
    this.createLeadsForm.controls['product'].setValue(data.information.product);
    this.createLeadsForm.controls['property_type'].setValue(data.information.property_type);
        ...
        .subscribe(data => {
          if (data.response === 200) {
            ...
            if(!this.edit_lead_id){
                ...
                this.createLeadsForm.controls['leads_type'].setValue('0');
                this.createLeadsForm.controls['create_by_type'].setValue(1);
                this.removeFile();
                this.typeWiseInput = '';
                this.showMaxPrice = false;
