...
@Component({
  ...
  templateUrl: './for-rent-qc-property-list.component.html',
  styleUrls: ['./for-rent-qc-property-list.component.scss']
})
export class FRQcPropertyListComponent implements OnInit {
  ...
  get_count() {
    ...
    this.dataService.getAll('for-rent-property/count' + getData)
      .subscribe(async(res) => {
          if (res.code === 200) {
