...
@Component({
  ...
  templateUrl: './for-land-sale-qc-property-list.component.html',
  styleUrls: ['./for-land-sale-qc-property-list.component.scss']
})
export class FLSQcPropertyListComponent implements OnInit {
  ...
  get_count() {
    ...
    this.dataService.getAll('for-land-sale-property/count' + getData)
      .subscribe(async(res) => {
          if (res.code === 200) {
