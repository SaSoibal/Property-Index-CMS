...
export class ForSaleComponent implements OnInit {
    ...
    getStickerList() {
        ...
        this.dataService.create(postdata, 'common/sticker-list')
            .subscribe(
                response => {
                    if (response.code === 200) {
                        this.sticker_list = response.data.stickers;
                    } else {
                        this.sticker_list = [];
                    }
                },
    ...
    showEditForm(data) {
        ...
        this.extraInformation.patchValue({
            ...
            sticker_id: data.other_info?.sticker_id,
            available_in: data.other_info?.available_in,
