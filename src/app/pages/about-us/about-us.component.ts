...
export class AboutUsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.createLoneForm = this.fb.group({
      ...
      data_title4_bn: ['', ''],
      video_link: ['', ''],
      master_mind_title_en: ['', ''],
      master_mind_title_bn: ['', ''],
      master_mind_text_en: ['', ''],
      master_mind_text_bn: ['', ''],
      master_mind_image: ['', ''],
      master_mind_name_en: ['', ''],
    ...
    this.dataService.create(inputData, 'get-about-us')
      .subscribe(async (data) => {
          if (data.response === 200) {
            ...
            this.OurMissionImageFile = this.rootUrl + aboutData.mission_vision_image ? this.rootUrl + aboutData.mission_vision_image : '';
            ...
            this.createLoneForm.patchValue({
              ...
              master_mind_title_en: aboutData.master_mind_title_en,
