...
@Component({
    selector: 'app-loan-benefit',
    templateUrl: './loan-benefit.component.html',
    styleUrls: ['./loan-benefit.component.scss']
})
export class LoanBenefitComponent implements OnInit {
    ...
    createModel() {
        const dialogRef = this.dialog.open(CreateLoanBenefit, {
            width: '600px',
            data: {
                title_en: '',
                title_bn: '',
    ...
    openRedModel(data) {
        const dialogRef = this.dialog.open(ViewLoanBenefit, {
            width: '800px',
            data: {
    ...
    get_list(postdate) {
        this.dataService.getAll('loan-benefit-list' + postdate)
            .subscribe(async (res) => {
                if (res.response === 200) {
    ...
    deleteModel(data) {
        const dialogRef = this.dialog.open(DeleteLoanBenefit, {
            data: {
                loan_benefit_id: data.id,
                title_en: data.title_en,
                old_thumbnail: data.thumbnail,
...
@Component({
    selector: 'create-loan-benefit',
    templateUrl: './create-loan-benefit.html',
    styleUrls: ['./loan-benefit.component.scss']
})
export class CreateLoanBenefit {
    showData = 'EN';
    rootUrl = this.common.rootUrl + 'public/uploads/';
    ...
    constructor (public dialogRef: MatDialogRef<CreateLoanBenefit>,
    ...
    onClick(): void {
        ...
        this.dataService.create(this.data, 'loan-benefit-create-update')
            .subscribe(data => {
...
@Component({
    selector: 'view-loan-benefit',
    templateUrl: './view-loan-benefit.html',
    styleUrls: ['./loan-benefit.component.scss']
})
export class ViewLoanBenefit {
    rootUrl = this.common.rootUrl + 'public/uploads/';
    // tslint:disable-next-line: max-line-length
    constructor (public dialogRef: MatDialogRef<ViewLoanBenefit>,
        @Inject(MAT_DIALOG_DATA) public data: DialogData,
        private dataService: DataService,
        private common: CommonService) {
    }
...
@Component({
    selector: 'delete-loan-benefit',
    templateUrl: './delete-loan-benefit.html',
    styleUrls: ['./loan-benefit.component.scss']
})
export class DeleteLoanBenefit {
    // tslint:disable-next-line: max-line-length
    constructor (public dialogRef: MatDialogRef<DeleteLoanBenefit>,
        @Inject(MAT_DIALOG_DATA) public data: DialogData,
        private dataService: DataService,
        private common: CommonService) {
    }
