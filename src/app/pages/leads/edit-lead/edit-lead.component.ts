...
export class EditLeadComponent implements OnInit {
  ...
  setDataList(data) {
      this.createLeadsForm.patchValue({
        country_code: data.lead.phone_code,
        cell_no: data.lead.phone_no,
        team_id: data.information?.lead_task?.team_id,
        team_manager_id: data.information?.lead_task?.manager_id,
        task_type: data.information?.lead_task?.status,
        allocated_to: data.information?.lead_task?.allocated_to,
        allocated_date: data.information?.lead_task?.allocated_date,
  ...
  changeProductType(product){
    if(product){
      ...
      console.log(product.type_option);
