...
@Component({
  selector: 'app-sell-permission',
  templateUrl: './sell-permission.component.html',
  styleUrls: ['./sell-permission.component.scss']
})
export class SellPermissionComponent implements OnInit {
